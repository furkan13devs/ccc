...
def usage():
    ...
    print("")
    print("                                               
 _____      ____ _ _ __ | |_ _____  __   ___ ___ 
/ __\ \ /\ / / _` | '_ \| __/ _ \ \/ /  / __/ __|
\__ \\ V  V / (_| | | | | ||  __/>  <  | (_| (__ 
|___/ \_/\_/ \__,_|_| |_|\__\___/_/\_\  \___\___|
                                                 
                                                          ")
    print("    python carder.py [-b] 478500xxxxxxxxxx -u 20 -d -c ")
    print("    xxxx Yazan Yerleri Değiştirmeyin.")
    print("")
    print("Ayar Açıklamaları :")
    print("    -b, -brute         CC Bulunucak Numara")
    print("    -u, -arama         CC Bulunulacak Sayısı")
    print("    -c, --ccv          Kredi Kartın Şİfresi")
    print("    -d, --date         Kredi Kartın Kullanım Tarihi")
    print("")
    print("6 Sayılı Rakam Yazıyoruz -u Bölümüne sonrada yanına 10 tane x işareti koyuyoruz ve buluyor.")
    print("")
    print("")
...
def ccgen(bin_format):
    ...
    if len(bin_format) == 16:
        ...
        print("Recuerda que el formato del bin es: xxxxxxxxxxxxxxxx y consta de 16 digitos\n")
        print("Si deseas ayuda usa: ./carder.py -h\n")
        sys.exit()
...
def main(argv):
    ...
    if bin_format is not "":
        ...
        if not bin_list:
            ...
            print("\nArama Sonuçların Hepsi Bulundu.")
